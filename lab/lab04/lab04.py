...
def distance(city1, city2):
    ...
    """
    "*** YOUR CODE HERE ***"
    def diff(get_attribute,name1,name2):
        return get_attribute(name1)-get_attribute(name2)
    diff_lat=diff(get_lat,city1,city2)
    diff_lon=diff(get_lon,city1,city2)
...
def closer_city(lat, lon, city1, city2):
    ...
    elif distance(target,city1)>distance(target,city2):
